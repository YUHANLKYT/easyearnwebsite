...
export default async function EarnPage({ searchParams }: { searchParams: SearchParams }) {
  ...
  const offerwalls = [
    ...
    },
    {
      ...
      logoWidth: 480,
      logoHeight: 96,
      logoClass: "h-auto w-[112%] max-w-none -ml-2 sm:w-[110%] sm:-ml-3",
      logoDisabledClass: "h-auto w-[112%] max-w-none -ml-2 opacity-70 sm:w-[110%] sm:-ml-3",
