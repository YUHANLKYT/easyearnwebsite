      ...
      <div className="mb-4 grid gap-3 lg:grid-cols-2">
        <article className="rounded-2xl border border-slate-100 bg-white/85 p-4 shadow-sm">
          ...
          <button
            ...
            disabled={!canOpen7}
            className={`case-chest-btn case-chest-btn-sm case-chest-btn-violet mt-3 ${chestBurstTier === 7 || (spinning && activeTier === 7) ? "case-chest-live" : ""} ${!canOpen7 ? "case-chest-disabled" : ""}`}
          >
        ...
        <article className="rounded-2xl border border-slate-100 bg-white/85 p-4 shadow-sm">
          ...
          <button
            ...
            disabled={!canOpen14}
            className={`case-chest-btn case-chest-btn-sm case-chest-btn-blue mt-3 ${chestBurstTier === 14 || (spinning && activeTier === 14) ? "case-chest-live" : ""} ${!canOpen14 ? "case-chest-disabled" : ""}`}
          >
            <span className="case-chest-glow" />
            <span className="case-chest-lid" />
            <span className="case-chest-base" />
